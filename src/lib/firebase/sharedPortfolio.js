...
export function getSharedPriceReviewsCollectionRef() {
    const db = getRequiredFirebaseDb();
    return collection(db, SHARED_PORTFOLIO_COLLECTION, SHARED_PORTFOLIO_DOC_ID, 'priceUpdateReviews');
}
...
export function getSharedAssetTransactionsCollectionRef() {
    const db = getRequiredFirebaseDb();
    return collection(db, SHARED_PORTFOLIO_COLLECTION, SHARED_PORTFOLIO_DOC_ID, 'assetTransactions');
}
...
export function getSharedAssetPriceHistoryCollectionRef(assetId) {
    const db = getRequiredFirebaseDb();
    return collection(db, SHARED_PORTFOLIO_COLLECTION, SHARED_PORTFOLIO_DOC_ID, 'assets', assetId, 'priceHistory');
}
