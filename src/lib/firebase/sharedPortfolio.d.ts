...
export declare function getSharedAssetTransactionsCollectionRef(): import("@firebase/firestore").CollectionReference<import("@firebase/firestore").DocumentData, import("@firebase/firestore").DocumentData>;
...
export declare function getSharedAnalysisSessionsCollectionRef(): import("@firebase/firestore").CollectionReference<import("@firebase/firestore").DocumentData, import("@firebase/firestore").DocumentData>;
export declare function getSharedAnalysisThreadsCollectionRef(): import("@firebase/firestore").CollectionReference<import("@firebase/firestore").DocumentData, import("@firebase/firestore").DocumentData>;
export declare function getSharedQuarterlyReportsCollectionRef(): import("@firebase/firestore").CollectionReference<import("@firebase/firestore").DocumentData, import("@firebase/firestore").DocumentData>;
...
export declare function getSharedAnalysisThreadTurnsCollectionRef(threadId: string): import("@firebase/firestore").CollectionReference<import("@firebase/firestore").DocumentData, import("@firebase/firestore").DocumentData>;
