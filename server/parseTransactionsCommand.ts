...
const PARSE_ROUTE = '/api/parse-transactions-command' as const;
...
function normalizeRequest(payload: unknown): ParseTransactionsCommandRequest {
...
export function getParseTransactionsCommandErrorResponse(error: unknown) {
...
export async function parseTransactionsFromCommand(
  payload: unknown,
): Promise<ParseTransactionsCommandResponse> {
