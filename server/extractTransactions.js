...
function getGeminiApiKey() {
    ...
    if (!apiKey) {
        throw new ExtractTransactionsError('未設定 GEMINI_API_KEY 或 GOOGLE_API_KEY，暫時無法解析交易截圖。', 500);
    }
    return apiKey;
}
...
export function getExtractTransactionsErrorResponse(error) {
...
export async function extractTransactionsFromScreenshot(payload) {
